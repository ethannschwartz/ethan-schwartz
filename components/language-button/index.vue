<template>
  <div @mouseleave="isVisible = false" data-aos="fade-down" class="w-fit type-primary">
    <div class="relative flex items-center">
      <button @mouseover="isVisible = true" class="flex items-center hover:text-emerald-600 dark:hover:text-emerald-400">
        <i class="fi fi-rr-earth-americas"></i>
      </button>
      <div :class="isVisible ? 'opacity-100' : 'translate-y-1 opacity-0'" class="duration-150 type-secondary absolute top-full -right-1/2 pt-2 w-fit">
          ...
          <ul>
            <li v-for="language in languages">
              <button
                  ...
                  class="w-full px-3 py-1 text-sm hover:bg-zinc-100 hover:text-black dark:hover:bg-zinc-700 dark:hover:text-white active:bg-zinc-200 rounded"
              >
                {{ language.label }}
              </button>
            </li>
